...
const shots = [
  ...
  ['status-drag.jpg', '拿起來放下去：來源變灰、目標格發光、放到格線外直接丟棄'],
...
const rows = [
  ...
  ['ok', '格線外放手直接丟棄', '拖離星期一到日的早／晚格子後放手 → 該項目從本週刪除',
   '元件測試：未打勾與已打勾項目都會刪除，且不會進補做池'],
...
<div class="wrap">
  ...
  <div class="card">
    <div class="stat">
      ...
      <div><b>142</b><span>單元 + 元件測試</span></div>
