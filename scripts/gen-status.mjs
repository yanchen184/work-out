...
const rows = [
  ...
  ['ok', '部位進度可加臨時訓練', '按 ＋ 輸入「長跑」等本週額外完成項目，新增為 1/1 並可個別刪除',
   '真實瀏覽器完成輸入與新增；重開保留、刪除、整體進度、舊資料相容與跨裝置 LWW 均有回歸測試'],
...
<div class="wrap">
  ...
  <div class="card">
    <div class="stat">
      ...
      <div><b>159</b><span>單元 + 元件測試</span></div>
...
${rowHtml}
  ...
  <div class="card">
    <ul>
      ...
      <li><strong>臨時訓練只屬於本週</strong> — 部位進度的 ＋ 可新增長跑等額外完成項目，
        以 1/1 呈現並參與總進度，不污染每週固定模板。</li>
