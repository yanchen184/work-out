...
const rows = [
  ...
  ['ok', '底部垃圾桶吸附刪除', '拿起後底部出現垃圾桶；往下靠近時方塊吸附，放手從本週刪除',
   'iOS 手勢從 pointerdown 即 capture；元件測試涵蓋吸附、放手刪除、已打勾刪除且不進補做池'],
...
<div class="wrap">
  ...
  <div class="card">
    <div class="stat">
      ...
      <div><b>144</b><span>單元 + 元件測試</span></div>
  ...
  <div class="card">
    <ul>
      ...
      <li><strong>手機式垃圾桶刪除</strong> — 拿起方塊時底部浮出垃圾桶，靠近後方塊會縮小吸附，
        垃圾桶開蓋並震動提示，放手才真的刪除。iOS 從按下就 capture pointer，
